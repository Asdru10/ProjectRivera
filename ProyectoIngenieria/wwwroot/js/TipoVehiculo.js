            ...
            
            {
                ...
                "render": function (data) {
                    return `
                                ...
                                <button onclick="Eliminar('/Admin/TipoVehiculo/Eliminar/${data}')" class="btn btn-danger btn-sm mx-2" title="Eliminar">
...
function Eliminar(url) {
    Swal.fire({
        title: '¿Estás seguro?',
        text: "Este tipo de vehículo será eliminado permanentemente",
        icon: 'warning',
